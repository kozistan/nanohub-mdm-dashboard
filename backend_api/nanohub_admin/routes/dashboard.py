"""
NanoHUB Admin Panel - Dashboard Routes
=======================================

Provides:
- / - Admin dashboard (command categories)
- /command/<cmd_id> - Command execution page
- /execute - Execute command (POST)
- /api/commands - Get all commands (JSON)
"""
...
# Create Blueprint (no url_prefix - routes are relative to admin_bp)
        ...
        <div class="panel">
            <div class="admin-header">
                ...
                <div style="text-align:center;">
                    ...
                    <span style="color:#D91F25;font-size:0.9em;">Potentially dangerous operation</span>
                    {% endif %}
                </div>
                <div>
...
@dashboard_bp.route('/command/<cmd_id>')
@login_required_admin
