...
from flask import Blueprint, render_template_string, session, redirect, url_for, request, jsonify, send_file, Response
        ...
        <div class="panel">
            ...
            <div id="tab-users" class="settings-section">
                ...
                <div class="settings-card">
                    ...
                    <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end;">
                        ...
                        <button class="btn" style="background:#5FC812;color:#0D0D0D;border-color:#5FC812;" onclick="saveUserRole()">Save Role</button>
                    </div>
                </div>
            ...
            <div id="tab-manifests" class="settings-section">
                <div class="manifests-header">
                    ...
                    <button class="btn" style="background:#5FC812;color:#0D0D0D;border-color:#5FC812;" onclick="showAddManifestModal()">+ Add Manifest</button>
                </div>
            ...
            <div id="tab-session" class="settings-section">
                ...
                <div class="settings-card">
                    ...
                    <button class="btn" style="background:#10b981;color:white;margin-top:10px;" onclick="saveSessionSettings()">Save Session Settings</button>
                </div>
            </div>
            ...
            <div id="tab-audit" class="settings-section">
                ...
                <div class="settings-card">
                    ...
                    <button class="btn" style="background:#10b981;color:white;margin-top:10px;" onclick="saveAuditSettings()">Save Audit Settings</button>
                    <button class="btn" style="background:#F5A623;color:#0D0D0D;border-color:#F5A623;margin-top:10px;margin-left:10px;" onclick="cleanupOldLogs()">Cleanup Old Logs Now</button>
                </div>
            </div>
            ...
            <div id="tab-backup" class="settings-section">
                <div class="manifests-header">
                    ...
                    <button class="btn" style="background:#8826E3;color:white;border-color:#8826E3;" onclick="createBackup()">+ Create Backup</button>
                </div>
